...
public class Authentication {
    ...
    public void deveAcessarAplicacaoWeb(){
        String cookie =
                given()
                        .log().all()
                        .formParam("email", "jeferson.lopes@dbserver.com.br")
...
//                        .log().all()
        ...
        System.out.println("Atualizado: " + cookie);
        ...
        .then()
                .log().all()
                .statusCode(200)
                .body("html.body.table.tbody.tr[1].td[0]", is("conta 1"))
